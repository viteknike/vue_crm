  ...
  <form class="card auth-card" @submit.prevent="submitHandler">
    <div class="card-content">
      ...
      <div class="input-field">
        ...
        <small class="helper-text invalid" v-else-if="($v.email.$dirty && !$v.email.required)">Ведите Email</small>
      </div>
      <div class="input-field">
        ...
        <small class="helper-text invalid" v-else-if="($v.password.$dirty && !$v.password.minLength)">Минимальная длина пароля {{$v.password.$params.minLength.min}} символов. Введено символов : {{password.length}} </small>
      </div>
    </div>
